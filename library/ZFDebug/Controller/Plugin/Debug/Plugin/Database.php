 ...
 * @license    http://code.google.com/p/zfdebug/wiki/License     New BSD License
 */
class ZFDebug_Controller_Plugin_Debug_Plugin_Database extends ZFDebug_Controller_Plugin_Debug_Plugin implements 
            ...
            if( $profiles = $adapter->getProfiler()->getQueryProfiles() ){
                ...
                foreach( $profiles as $profile ){
                    $html .= '<li><strong>[' .
                     ...
                     ' ms]</strong> ' . htmlspecialchars($profile->getQuery()) .
                     '</li>';
                }
                $html .= '</ol>';
            }
