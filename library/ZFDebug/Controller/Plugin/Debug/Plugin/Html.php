 ...
 * @license    http://code.google.com/p/zfdebug/wiki/License     New BSD License
 */
class ZFDebug_Controller_Plugin_Debug_Plugin_Html implements 
ZFDebug_Controller_Plugin_Debug_Plugin_Interface {
    ...
    public function getPanel(){
        ...
        $panel .= '<span id="ZFDebug_Html_Tagcount"></span> Tags<br />' .
         ...
         '<form method="POST" action="http://validator.w3.org/check" target="_blank"><input type="hidden" name="fragment" value="' .
         htmlentities($body) .
         '"><input type="submit" value="Validate With W3"></form>';
        return $panel;
    }
}