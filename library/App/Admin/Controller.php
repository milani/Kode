...
/**
 * Default parent controller for all the admin controllers
 *
 * @category App
 * @package App_Admin
 * @copyright Copyright (c) 2011, Morteza Milani
 */
abstract class App_Admin_Controller extends App_Controller {
    ...
    protected function _getPage($default = 1){
        $session = new Zend_Session_Namespace('App.Admin.Controller.Pagination');
