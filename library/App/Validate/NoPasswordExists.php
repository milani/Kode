...
/**
 * Checks if a password doesn't exists in the database.
 * 
 * Allows us to check the user's password history and force the  
 * selection of a different password
 *
 * @category App
...
class App_Validate_NoPasswordExists extends Zend_Validate_Db_NoRecordExists {
    ...
    self::ERROR_RECORD_FOUND => 'You have use this password in the past. Please pick a different one'
    );
